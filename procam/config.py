"""Cấu hình ProCam: dataclass lồng nhau + lưu/nạp JSON, hỗ trợ preset."""
...
CONFIG_DIR = Path(os.environ.get("XDG_CONFIG_HOME", Path.home() / ".config")) / "procam"
...
class OutputConfig:
    ...
    record_dir: str = str(Path.home() / "Videos" / "ProCam")
